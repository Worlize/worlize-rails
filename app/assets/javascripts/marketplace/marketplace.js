jQuery(function($) {
    ...
    $(document).on('click', 'ul.item-thumbnail-container > li > a, a[data-type=MarketplaceItem]', function(event) {
        var spinner;
        var image;
    ...
    $(document).on('click', '.overlay-dialog .cancel-button', function(event) {
        $.fancybox.close();
    });
    
    $(document).on('click', '.confirm-purchase-dialog .confirm-button', function(event) {
        $.ajax({
            dataType: 'json',
    ...
    if (loggedIn) {
        ...
        $(document).on('mouseover', '.buy-button', function(event) {
        ...
        $(document).on('mousemove', '.buy-button', function(event) {
            if (mustBeLoggedInTooltip) {
        ...
        $(document).on('mouseout', '.buy-button', function(event) {
            if (mustBeLoggedInTooltip) {
                mustBeLoggedInTooltip.hide();
            }
        });
